...
user in an INI file next to MarkTextPortable.exe called MarkTextPortable.ini.
...
copy AppNamePortable.ini from this directory to MarkTextPortable.ini next to
MarkTextPortable.exe. The options in the INI file are as follows:
